                    ...
                    <div class="card-body">
                        <form method="POST" action="<?= BASE_URL ?>/admin.php?action=editExam&id=<?= $results['exam_id'] ?>">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control" readonly value="<?= htmlspecialchars($results['total_questions'] ?? 0) ?>">
                            </div>
                                    ...
                                    <?php foreach ($results['subjects'] as $sub): ?>
                                        <div class="form-check mb-1">
                                            <input type="checkbox" class="form-check-input" 
                                                   name="exam_question_sources[<?= $bank['bank_id'] ?>][<?= $sub['subject_id'] ?>]" 
                                                   value="1"
                                                   <?= isset($results['exam_question_sources'][$bank['bank_id']][$sub['subject_id']]) ? 'checked' : '' ?>>
