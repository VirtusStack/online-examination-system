        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <form method="POST" action="<?= BASE_URL ?>/admin.php?action=editBank&id=<?= htmlspecialchars($results['bank']['bank_id']) ?>">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="subject_id" class="form-control" required>
                                    <?php foreach ($results['subjects'] as $subject): ?>
                                        <option value="<?= $subject['subject_id'] ?>" <?= ($subject['subject_id'] == $results['bank']['subject_id']) ? 'selected' : '' ?>>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="description" class="form-control" rows="3"><?= htmlspecialchars($results['bank']['description'] ?? '') ?></textarea>
                            </div>
