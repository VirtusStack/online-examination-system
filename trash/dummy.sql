...
VALUES
(1,'Math Bank 1','Algebra and arithmetic questions', NOW()),
(2,'Physics Bank 1','Mechanics questions', NOW()),
(3,'Chemistry Bank 1','Chemical reactions questions', NOW()),
(4,'Biology Bank 1','Human biology questions', NOW()),
(5,'CS Bank 1','Programming questions', NOW())
...
VALUES
(1,'Mathematics','Basic and advanced math topics', NOW()),
(2,'Physics','Mechanics, optics, thermodynamics', NOW()),
(3,'Chemistry','Organic, inorganic, and physical chemistry', NOW()),
(4,'Biology','Botany, Zoology, Genetics', NOW()),
(5,'Computer Science','Programming, algorithms, data structures', NOW())
